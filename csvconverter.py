...
class Converter():
    ...
    def heb_greg_csv(self, csv_file):
        '''
        ...
        today = today.split(',')
        current_heb_year, current_heb_month, current_heb_day = self.greg_to_heb(today[0],today[1],today[2])
            ...
            for row in csv_reader:
                for num in range(3):
                    ...
                    if num_requests == 80:
                        ...
                        secular_year, secular_month, secular_day = self.heb_to_greg(str(int(current_heb_year) + num), row[2], row[3])
                        num_requests += 1
...
hebcal_converter = Converter()
hebcal_converter.heb_greg_csv('hebrew_dates.csv')
